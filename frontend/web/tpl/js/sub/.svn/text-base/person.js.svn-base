...
var vue1 = new Vue({
	...
	created: function () {
		// getdata("GetCus", "get", {userid: localStorage.getItem("userid")}, !0, function (e) {
		// 	1 == e.success && (vue1.myid = e.body[0].myId, vue1.tel = e.body[0].tel, vue1.accountName = e.body[0].accountName, vue1.openingBank = e.body[0].openingBank, vue1.isReally = e.body[0].isReally, vue1.parentId = e.body[0].parentId, vue1.grade = e.body[0].grade, vue1.name = e.body[0].name, vue1.weixin = e.body[0].weiXin, vue1.alipay = e.body[0].alipay, vue1.CardTel = e.body[0].cardTel, localStorage.setItem("cardtel", e.body[0].cardTel), "" == e.body[0].cardTel ? vue1.obligate = !0 : vue1.obligate = !1)
		// }, function (e) {
		// })
	},
	computed: {
	...
	methods: {
		gethref: function (e) {
			...
			getdata("GetCus", "get", {userid: localStorage.getItem("userid")}, !0, function (e) {
				1 == e.success && (vue1.myid = e.body[0].myId, vue1.isReally = e.body[0].isReally, vue1.parentId = e.body[0].parentId, vue1.grade = e.body[0].grade, vue1.weixin = e.body[0].weiXin, vue1.alipay = e.body[0].alipay)
			}, function (e) {
			}), vue1.photo = localStorage.getItem("headimg"), mui("#person").pullRefresh().endPulldown()
	...
	mounted: function () {
		mui.plusReady(function () {
			currentWebview = plus.webview.currentWebview(), template = plus.webview.getWebviewById("template_second"), subWebview = plus.webview.getWebviewById("sub_template_second"), mui.init({
				swipeBack: !1,
				pullRefresh: {
					container: "#person",
					down: {
			...
			}), mui("#person").on("tap", ".headbox", function () {
			...
			}), mui(".lists li").on("tap", "a:not(.telcheck)", function () {
				var e = this.getAttribute("data-title");
...
window.addEventListener("updateimg", function (e) {
});
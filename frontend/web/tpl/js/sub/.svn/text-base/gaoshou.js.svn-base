var pageNo1 = 1, pageNo2 = 1, template = null, subWebview = null, home = null, yztime = 60, vue1 = new Vue({
	...
	created: function () {
		// getmarketdata("GetMyHangTranAce", "get", {
	...
	methods: {
		...
		// }, buythis: function () {
		// 	return this.range < 200 ? (this.range = 200, void mui.toast("最小为200")) : this.range > 5e3 ? (this.range = 5e3, void mui.toast("最大为5000")) : void mui.toast("交易成功")
		// }, getnewpage: function (e, t) {
		// 	0 == e ? getmarketdata("GetMyHangTranAce", "get", {
		// 		userid: localStorage.getItem("userid"),
		// 		pageno: t,
		// 		type: e
		// 	}, !0, function (e) {
	...
	mounted: function () {
		mui.init({swipeBack: !1}), mui.plusReady(function () {
			template = plus.webview.getWebviewById("template_second"), subWebview = plus.webview.getWebviewById("sub_template_second"), home = plus.webview.getWebviewById("barItem/mine.html"), new Clipboard(".copy"), mui(".mui-scroll-wrapper").scroll({
			...
			}), mui("#gaoshou").on("tap", ".guabuy", function () {
				...
				mui.confirm("确认挂单吗？", "确认挂单", ["确认", "取消"], function (e) {
					0 == e.index && getmarketdata("StartHangTransferAce", "get", {
						userid: localStorage.getItem("userid"),
						amount: vue1.range,
						price: vue1.total
					}, !0, function (e) {
				...
				"show4" == e && (vue1.list2.length > 0 || 0 == vue1.list2.length && getmarketdata("GetMyHangTranAce", "get", {
					userid: localStorage.getItem("userid"),
					pageno: 1,
					type: "1"
				}, !0, function (e) {
			...
			}), mui("#gaoshou").on("tap", ".shuaxin", function () {

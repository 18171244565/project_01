var pageNo1 = 1, pageNo2 = 1, template = null, subWebview = null, home = null, yztime = 60, vue1 = new Vue({
	...
	mounted: function () {
		...
		// 			}
		// 		}
		// 	}), mui("#xinshou").on("tap", ".guabuy", function () {
		// 		if (vue1.total < .1) return vue1.total = .1, void mui.toast("最小为0.1");
		// 		if (vue1.range < 1) return vue1.range = 1, void mui.toast("数量最小为1");
		// 		if (vue1.range > 10) return vue1.range = 10, void mui.toast("数量最大为10");
		...
		// 	}), mui("#xinshou").on("tap", ".shuaxin", function () {

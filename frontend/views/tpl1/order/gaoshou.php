...
<header class="mui-bar mui-bar-nav own-main-background-color" style="position: static;">
    ...
    <h1 class="mui-title">高手挂单</h1>
</header>
<div class="mui-content" id="gaoshou">
    <div class="messagebox"><p class="xuxianbox" style="line-height:.4rem;text-align:center">
            算力≥200用户可进行200-5000<?= MONEY_NAME ?>议价交易！</p></div>
    <div class="guoneibox" style="position:relative">
        ...
        <div class="mui-input-row mui-input-range field-contain">
            <div><input type="range" id="field-range" step="10" value="60" min="200" max="5000" v-model="range"></div>
        ...
        <div class="guoneitotal"><p>买入<span v-text="range"></span><?= $money_name ?>，出价<span
            ...
            <div class="xuzhi" style="margin-top:.15rem">
                <!--<a href="<?= \yii\helpers\Url::to('shopping/xuzhi') ?>" data-title="高手挂单交易须知"><span
                        class="iconfont">&#xe67f;</span> <span>高手挂单交易须知</span></a>--></div>
        </div>
        <ul class="tapbox2">
...
<script src="/tpl/js/sub/gaoshou.js" charset="utf-8"></script>

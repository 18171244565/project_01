            ...
            <div class="mui-scroll">
                <div class="kuangshibox" style="position:relative">
                    <ul class="kuangshinum">
                        ...
                        <li><p class="first" v-text="'高：'+high">高：<?= $max ?></p>

                            <p class="second" v-text="'量：'+amount">量：<?= $orderNum ?></p></li>
                    </ul>
                    <ul class="tapbox">

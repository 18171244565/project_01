...
<div class="page-content">
    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="" role="form">
        ...
        <div class="form-group col-sm-12">
            ...
            <div class="col-sm-6">
                <input type="text" name="Notice[title]" value="" placeholder="请输入公告标题" class="form-control">
            </div>
        ...
        <div class="form-group col-sm-12">
            ...
            <div class="col-sm-6">
                <textarea class="form-control" style="resize: none" rows="5" name="Notice[content]"></textarea>
            </div>
            <div class="col-sm-3 help-block">
        ...
        <div class="form-group col-sm-12" style="margin-top: 50px">
            ...
            <div class="col-sm-5">
                <button type="submit" class="btn btn-sm btn-primary">发布公告</button>
            </div>
        </div>
    </form>
</div>
